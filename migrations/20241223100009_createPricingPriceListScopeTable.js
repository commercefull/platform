...
exports.up = async function (knex) {
  const hasTable = await knex.schema.hasTable('pricingPriceListScope');
  if (hasTable) return;

  await knex.schema.createTable('pricingPriceListScope', table => {
...
exports.down = async function (knex) {
  await knex.schema.dropTableIfExists('pricingPriceListScope');
};
