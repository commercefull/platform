...
exports.up = function (knex) {
  return knex.schema.createTable('supportFaqArticle', function (table) {
    table.uuid('faqArticleId').primary().defaultTo(knex.raw('uuidv7()'));
    table.uuid('faqCategoryId').references('faqCategoryId').inTable('supportFaqCategory').onDelete('SET NULL');
...
exports.down = function (knex) {
  return knex.schema.dropTableIfExists('supportFaqArticle');
};
