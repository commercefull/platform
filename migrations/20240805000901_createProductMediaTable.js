exports.up = function(knex) {
  return knex.schema.createTable('productMedia', t => {
    ...
    knex.raw('CREATE UNIQUE INDEX productmedia_productid_isprimary_unique ON "productMedia" ("productId") WHERE "isPrimary" = true AND "productVariantId" IS NULL'),
    knex.raw('CREATE UNIQUE INDEX productmedia_variant_isprimary_unique ON "productMedia" ("productVariantId") WHERE "isPrimary" = true AND "productVariantId" IS NOT NULL')
  ]));
};
