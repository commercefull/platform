...
exports.up = function(knex) {
  return knex.schema.createTable('emailCampaignRecipient', function(table) {
    table.uuid('emailCampaignRecipientId').primary().defaultTo(knex.raw('uuidv7()'));
    ...
    table.unique(['emailCampaignId', 'email']);
...
exports.down = function(knex) {
  return knex.schema.dropTableIfExists('emailCampaignRecipient');
};
