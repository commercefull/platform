exports.up = function(knex) {
  return knex.schema.createTable('productListItem', t => {
    ...
    knex.raw('CREATE UNIQUE INDEX productlistitem_variant_unique ON "productListItem" ("listId", "productId", "productVariantId") WHERE "productVariantId" IS NOT NULL'),
    knex.raw('CREATE UNIQUE INDEX productlistitem_product_unique ON "productListItem" ("listId", "productId") WHERE "productVariantId" IS NULL')
  ]));
};
