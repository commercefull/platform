...
exports.up = async function (knex) {
  const hasTable = await knex.schema.hasTable('paymentPayout');
  if (hasTable) return;

  await knex.schema.createTable('paymentPayout', table => {
...
exports.down = async function (knex) {
  await knex.schema.dropTableIfExists('paymentPayout');
};
