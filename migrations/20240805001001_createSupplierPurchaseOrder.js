...
exports.up = function (knex) {
  return knex.schema.createTable('supplierPurchaseOrder', t => {
    t.uuid('supplierPurchaseOrderId').primary().defaultTo(knex.raw('uuidv7()'));
...
exports.down = function (knex) {
  return knex.schema.dropTable('supplierPurchaseOrder');
};
