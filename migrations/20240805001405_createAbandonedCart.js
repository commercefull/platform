...
exports.up = function(knex) {
  return knex.schema.createTable('abandonedCart', function(table) {
    table.uuid('abandonedCartId').primary().defaultTo(knex.raw('uuidv7()'));
...
exports.down = function(knex) {
  return knex.schema.dropTableIfExists('abandonedCart');
};
