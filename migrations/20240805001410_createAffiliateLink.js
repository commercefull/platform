...
exports.up = function(knex) {
  return knex.schema.createTable('affiliateLink', function(table) {
    table.uuid('affiliateLinkId').primary().defaultTo(knex.raw('uuidv7()'));
...
exports.down = function(knex) {
  return knex.schema.dropTableIfExists('affiliateLink');
};
