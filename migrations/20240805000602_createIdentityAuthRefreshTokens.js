...
exports.up = function (knex) {
  return knex.schema.createTable('identityRefreshTokens', t => {
    t.uuid('authRefreshTokenId').primary().defaultTo(knex.raw('uuidv7()'));
...
exports.down = function (knex) {
  return knex.schema.dropTable('identityRefreshTokens');
};
