...
exports.up = async function (knex) {
  const hasTable = await knex.schema.hasTable('identityAdminUser');
  if (hasTable) return;

  await knex.schema.createTable('identityAdminUser', table => {
...
exports.down = async function (knex) {
  await knex.schema.dropTableIfExists('identityAdminUser');
};
