...
exports.up = function (knex) {
  return knex.schema.createTable('supplierReceivingRecord', t => {
    t.uuid('supplierReceivingRecordId').primary().defaultTo(knex.raw('uuidv7()'));
...
exports.down = function (knex) {
  return knex.schema.dropTable('supplierReceivingRecord');
};
