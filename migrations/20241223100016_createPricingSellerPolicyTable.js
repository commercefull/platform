...
exports.up = async function (knex) {
  const hasTable = await knex.schema.hasTable('pricingSellerPolicy');
  if (hasTable) return;

  await knex.schema.createTable('pricingSellerPolicy', table => {
...
exports.down = async function (knex) {
  await knex.schema.dropTableIfExists('pricingSellerPolicy');
};
