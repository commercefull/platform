...
exports.up = function(knex) {
  return knex.schema.createTable('emailTemplate', function(table) {
    table.uuid('emailTemplateId').primary().defaultTo(knex.raw('uuidv7()'));
...
exports.down = function(knex) {
  return knex.schema.dropTableIfExists('emailTemplate');
};
