...
exports.up = function(knex) {
  return knex.schema.createTable('affiliate', function(table) {
    table.uuid('affiliateId').primary().defaultTo(knex.raw('uuidv7()'));
...
exports.down = function(knex) {
  return knex.schema.dropTableIfExists('affiliate');
};
