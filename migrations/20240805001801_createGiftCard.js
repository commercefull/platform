...
exports.up = function(knex) {
  return knex.schema.createTable('giftCard', function(table) {
    table.uuid('giftCardId').primary().defaultTo(knex.raw('uuidv7()'));
...
exports.down = function(knex) {
  return knex.schema.dropTableIfExists('giftCard');
};
