  ...
  await knex('promotionProductDiscount').insert([
    {
      ...
      maximumDiscountAmountCents: 5000,
      stackable: false,
  ...
  await knex('promotionGiftCard').insert([
    {
      ...
      isReloadable: true,
      minReloadAmountCents: 1000,
      maxReloadAmountCents: 50000,
      maxBalanceCents: 100000,
      restrictions: null,
      metadata: null,
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      lastUsedAt: now,
      usageCount: 1,
      totalRedeemedCents: 5000,
      isReloadable: false,
      minReloadAmountCents: null,
      maxReloadAmountCents: null,
