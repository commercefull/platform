  ...
  return knex('distributionShippingMethod').insert([
    {
      ...
      code: 'STANDARD',
      description: 'Standard shipping option (3-5 business days)',
      isActive: true,
      isDefault: true,
      domesticInternational: 'both',
      estimatedDeliveryDays: JSON.stringify({ min: 3, max: 5 }),
      priority: 10,
    },
    {
      name: 'Express Shipping',
      code: 'EXPRESS',
      description: 'Express shipping option (1-2 business days)',
      isActive: true,
      isDefault: false,
      domesticInternational: 'both',
    ...
    },
    {
      ...
      isDefault: false,
      domesticInternational: 'domestic',
      estimatedDeliveryDays: JSON.stringify({ min: 0, max: 1 }),
      priority: 30,
    },
    {
      name: 'International Standard',
      code: 'INTL_STD',
      description: 'International standard shipping (7-14 business days)',
      isActive: true,
      isDefault: false,
      domesticInternational: 'international',
      estimatedDeliveryDays: JSON.stringify({ min: 7, max: 14 }),
      priority: 40,
    },
    {
      name: 'International Express',
      code: 'INTL_EXP',
      description: 'International express shipping (3-5 business days)',
      isActive: true,
      isDefault: false,
      domesticInternational: 'international',
      estimatedDeliveryDays: JSON.stringify({ min: 3, max: 5 }),
