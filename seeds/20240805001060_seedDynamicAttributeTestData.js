...
exports.seed = async function (knex) {
  ...
  await knex('productType')
    ...
    .onConflict('productTypeId')
    .merge();

  // ==================== ATTRIBUTE GROUPS ====================
  await knex('productAttributeGroup')
    .insert([
      {
    ...
    .onConflict('productAttributeGroupId')
    .merge();

  // ==================== ATTRIBUTES ====================
  await knex('productAttribute')
    .insert([
      {
    ...
    .onConflict('productAttributeId')
    .merge();

  // ==================== ATTRIBUTE VALUES ====================
  await knex('productAttributeValue')
    .insert([
      // Colors
      {
        productAttributeValueId: ATTRIBUTE_VALUE_RED_ID,
      ...
      {
        productAttributeValueId: ATTRIBUTE_VALUE_BLUE_ID,
        attributeId: ATTRIBUTE_COLOR_ID,
        value: 'blue',
        displayValue: 'Blue',
        position: 20,
      ...
      {
        productAttributeValueId: ATTRIBUTE_VALUE_BLACK_ID,
        attributeId: ATTRIBUTE_COLOR_ID,
        value: 'black',
        displayValue: 'Black',
        position: 30,
      ...
      {
        productAttributeValueId: ATTRIBUTE_VALUE_WHITE_ID,
        attributeId: ATTRIBUTE_COLOR_ID,
        value: 'white',
        displayValue: 'White',
        position: 40,
      ...
      // Sizes
      {
        productAttributeValueId: ATTRIBUTE_VALUE_SIZE_XS_ID,
        attributeId: ATTRIBUTE_SIZE_ID,
        value: 'xs',
        displayValue: 'XS',
        position: 10,
        isDefault: false,
      ...
      {
        productAttributeValueId: ATTRIBUTE_VALUE_SIZE_S_ID,
        attributeId: ATTRIBUTE_SIZE_ID,
        value: 's',
        displayValue: 'S',
        position: 20,
      ...
      {
        productAttributeValueId: ATTRIBUTE_VALUE_SIZE_M_ID,
        attributeId: ATTRIBUTE_SIZE_ID,
        value: 'm',
        displayValue: 'M',
        position: 30,
      ...
      {
        productAttributeValueId: ATTRIBUTE_VALUE_SIZE_L_ID,
        attributeId: ATTRIBUTE_SIZE_ID,
        value: 'l',
        displayValue: 'L',
        position: 40,
      ...
      {
        productAttributeValueId: ATTRIBUTE_VALUE_SIZE_XL_ID,
        attributeId: ATTRIBUTE_SIZE_ID,
        value: 'xl',
        displayValue: 'XL',
        position: 50,
    ...
    .onConflict('productAttributeValueId')
    .ignore();
  ...
  if (testProducts.length > 0) {
    ...
    if (productAttributeData.length > 0) {
      ...
      for (const data of productAttributeData) {
        await knex('productAttributeValueMap').insert(data).onConflict().ignore();
      }
    }
  }
};
...
exports.down = async function (knex) {
  ...
  await knex('productAttributeSet')
    .whereIn('productAttributeSetId', [ATTRIBUTE_SET_DEFAULT_ID, ATTRIBUTE_SET_APPAREL_ID, ATTRIBUTE_SET_ELECTRONICS_ID])
    .delete();

  await knex('productAttributeValue')
    .whereIn('attributeId', [ATTRIBUTE_COLOR_ID, ATTRIBUTE_SIZE_ID, ATTRIBUTE_RAM_ID, ATTRIBUTE_STORAGE_ID])
    .delete();

  await knex('productAttribute')
    .whereIn('productAttributeId', [
      ATTRIBUTE_COLOR_ID,
      ATTRIBUTE_SIZE_ID,
      ATTRIBUTE_MATERIAL_ID,
      ATTRIBUTE_WEIGHT_ID,
  ...
  await knex('productAttributeGroup')
    .whereIn('productAttributeGroupId', [ATTRIBUTE_GROUP_BASIC_ID, ATTRIBUTE_GROUP_PHYSICAL_ID, ATTRIBUTE_GROUP_TECH_ID])
    .delete();

  await knex('productType')
    .whereIn('productTypeId', [PRODUCT_TYPE_SIMPLE_ID, PRODUCT_TYPE_CONFIGURABLE_ID, PRODUCT_TYPE_VIRTUAL_ID])
    .delete();
};
