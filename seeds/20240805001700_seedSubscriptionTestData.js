...
exports.seed = async function (knex) {
  ...
  await knex('productBasePrice')
    .insert({ productId: OPS_PRODUCT_ID, currencyCode: 'USD', priceCents: 2500 })
