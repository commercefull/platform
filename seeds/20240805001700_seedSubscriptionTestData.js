...
exports.seed = async function(knex) {
  ...
  await knex('subscriptionPlan').insert([
    {
      subscriptionPlanId: SUBSCRIPTION_PLAN_IDS.MONTHLY_BOX_BASIC,
      subscriptionProductId: SUBSCRIPTION_PRODUCT_IDS.MONTHLY_BOX,
    ...
    {
      subscriptionPlanId: SUBSCRIPTION_PLAN_IDS.ANNUAL_MEMBERSHIP_VIP,
      subscriptionProductId: SUBSCRIPTION_PRODUCT_IDS.ANNUAL_MEMBERSHIP,
  ...
  if (customerExists) {
    ...
    await knex('customerSubscription').insert([
      {
        customerSubscriptionId: CUSTOMER_SUBSCRIPTION_IDS.ACTIVE_MONTHLY,
      ...
      {
        customerSubscriptionId: CUSTOMER_SUBSCRIPTION_IDS.PAUSED_WEEKLY,
      ...
      {
        customerSubscriptionId: CUSTOMER_SUBSCRIPTION_IDS.CANCELLED_ANNUAL,
