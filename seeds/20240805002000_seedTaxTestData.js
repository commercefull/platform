...
const TAX_CATEGORY_IDS = {
  ...
  OPS_UPDATE: '0193a000-0000-7000-8000-000000000010',
  OPS_DELETE: '0193a000-0000-7000-8000-000000000011',
};
...
const TAX_RATE_IDS = {
  ...
  OPS_UPDATE: '0193a002-0000-7000-8000-000000000010',
  OPS_DELETE: '0193a002-0000-7000-8000-000000000011',
  OPS_UPDATE_2: '0193a002-0000-7000-8000-000000000012',
  OPS_DELETE_2: '0193a002-0000-7000-8000-000000000013',
};
...
exports.seed = async function (knex) {
  ...
  await knex('taxCategory').insert([
    ...
    // Dedicated categories for update/delete mutation tests
    {
      taxCategoryId: TAX_CATEGORY_IDS.OPS_UPDATE,
      name: 'Ops Update Test Category',
      code: 'test-ops-update',
    ...
    {
      taxCategoryId: TAX_CATEGORY_IDS.OPS_DELETE,
      name: 'Ops Delete Test Category',
      code: 'test-ops-delete',
  ...
  await knex('taxRate').insert([
    ...
    // Dedicated rates for update/delete mutation tests (one per mutating test)
    {
      taxRateId: TAX_RATE_IDS.OPS_UPDATE,
      taxCategoryId: TAX_CATEGORY_IDS.STANDARD,
      taxZoneId: TAX_ZONE_IDS.US_DOMESTIC,
      name: 'Ops Update Test Rate',
      rate: 7.5,
      type: 'percentage',
      priority: 9001,
      isCompound: false,
    ...
    {
      taxRateId: TAX_RATE_IDS.OPS_DELETE,
      taxCategoryId: TAX_CATEGORY_IDS.STANDARD,
      taxZoneId: TAX_ZONE_IDS.US_DOMESTIC,
      name: 'Ops Delete Test Rate',
      rate: 9.0,
      type: 'percentage',
      priority: 9002,
      isCompound: false,
    ...
    {
      taxRateId: TAX_RATE_IDS.OPS_UPDATE_2,
      taxCategoryId: TAX_CATEGORY_IDS.STANDARD,
      taxZoneId: TAX_ZONE_IDS.US_DOMESTIC,
      name: 'Ops Update Test Rate 2',
      rate: 7.5,
      type: 'percentage',
      priority: 9003,
      isCompound: false,
    ...
    {
      taxRateId: TAX_RATE_IDS.OPS_DELETE_2,
      taxCategoryId: TAX_CATEGORY_IDS.STANDARD,
      taxZoneId: TAX_ZONE_IDS.US_DOMESTIC,
      name: 'Ops Delete Test Rate 2',
      rate: 9.0,
      type: 'percentage',
      priority: 9004,
      isCompound: false,
