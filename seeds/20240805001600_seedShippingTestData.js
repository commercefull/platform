...
exports.seed = async function (knex) {
  ...
  await knex('shippingRate')
    .whereIn('shippingRateId', Object.values(RATE_IDS))
    .del()
    .catch(() => {});
  await knex('shippingMethod')
    .whereIn('shippingMethodId', Object.values(METHOD_IDS))
    .del()
    .catch(() => {});
  await knex('shippingZone')
    .whereIn('shippingZoneId', Object.values(ZONE_IDS))
    .del()
    .catch(() => {});
  await knex('shippingCarrier')
    .whereIn('shippingCarrierId', Object.values(CARRIER_IDS))
    .del()
    .catch(() => {});
  await knex('shippingPackagingType')
    .whereIn('shippingPackagingTypeId', Object.values(PACKAGING_IDS))
    .del()
    .catch(() => {});
    ...
    .insert([
      ...
      },
      {
        ...
        rateMatrix: JSON.stringify({
          tiers: [
            { min: 0, max: 5000, rate: 899 },
            { min: 5000, max: 10000, rate: 699 },
            { min: 10000, max: 99999900, rate: 499 },
          ],
        }),
        currency: 'USD',
        taxable: true,
