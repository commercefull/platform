/**
 * Seed: Distribution Shipping Carriers
 * Seeds the default shipping carriers (UPS, FedEx, USPS, DHL)
 */
exports.up = function (knex) {
  return knex('distributionShippingCarrier').insert([
    {
      name: 'UPS',
      code: 'UPS',
...
exports.down = function (knex) {
  return knex('distributionShippingCarrier').whereIn('code', ['UPS', 'FEDEX', 'USPS', 'DHL', 'CUSTOM']).delete();
};
