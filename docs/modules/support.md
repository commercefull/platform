...
|---|---|---|---|
| GET | `/support/agents` | `asyncHandler(getAgents)` | — |
| POST | `/support/agents` | `asyncHandler(createAgent)` | — |
| GET | `/support/agents/:id` | `asyncHandler(getAgent)` | — |
| PUT | `/support/agents/:id` | `asyncHandler(updateAgent)` | — |
| GET | `/support/alerts/price` | `asyncHandler(getPriceAlerts)` | — |
| POST | `/support/alerts/price` | `isCustomerLoggedIn` | — |
| GET | `/support/alerts/price/mine` | `isCustomerLoggedIn` | — |
| DELETE | `/support/alerts/price/mine/:id` | `isCustomerLoggedIn` | — |
| POST | `/support/alerts/price/notify` | `asyncHandler(notifyPriceAlerts)` | — |
| GET | `/support/alerts/stock` | `asyncHandler(getStockAlerts)` | — |
| POST | `/support/alerts/stock` | `isCustomerLoggedIn` | — |
| GET | `/support/alerts/stock/mine` | `isCustomerLoggedIn` | — |
| DELETE | `/support/alerts/stock/mine/:id` | `isCustomerLoggedIn` | — |
| POST | `/support/alerts/stock/notify` | `asyncHandler(notifyStockAlerts)` | — |
| GET | `/support/faq/articles` | `asyncHandler(getFaqArticles)` | — |
| POST | `/support/faq/articles` | `asyncHandler(createFaqArticle)` | — |
| GET | `/support/faq/articles/:id` | `asyncHandler(getFaqArticle)` | — |
| PUT | `/support/faq/articles/:id` | `asyncHandler(updateFaqArticle)` | — |
| DELETE | `/support/faq/articles/:id` | `asyncHandler(deleteFaqArticle)` | — |
| POST | `/support/faq/articles/:id/feedback` | `asyncHandler(submitFaqFeedback)` | — |
| POST | `/support/faq/articles/:id/publish` | `asyncHandler(publishFaqArticle)` | — |
| POST | `/support/faq/articles/:id/unpublish` | `asyncHandler(unpublishFaqArticle)` | — |
| GET | `/support/faq/articles/:slug` | `asyncHandler(getFaqArticleBySlug)` | — |
| GET | `/support/faq/articles/popular` | `asyncHandler(getPopularFaqArticles)` | — |
| GET | `/support/faq/categories` | `asyncHandler(getFaqCategories)` | — |
| POST | `/support/faq/categories` | `asyncHandler(createFaqCategory)` | — |
| GET | `/support/faq/categories` | `asyncHandler(getFaqCategories)` | — |
| GET | `/support/faq/categories/:id` | `asyncHandler(getFaqCategory)` | — |
| PUT | `/support/faq/categories/:id` | `asyncHandler(updateFaqCategory)` | — |
| DELETE | `/support/faq/categories/:id` | `asyncHandler(deleteFaqCategory)` | — |
| GET | `/support/faq/categories/:slug` | `asyncHandler(getFaqCategoryBySlug)` | — |
| GET | `/support/faq/categories/featured` | `asyncHandler(getFeaturedFaqCategories)` | — |
| GET | `/support/faq/search` | `asyncHandler(searchFaq)` | — |
| GET | `/support/tickets` | `asyncHandler(getTickets)` | — |
| POST | `/support/tickets` | `isCustomerLoggedIn` | — |
| GET | `/support/tickets/:id` | `asyncHandler(getTicket)` | — |
| PUT | `/support/tickets/:id` | `asyncHandler(updateTicket)` | — |
| POST | `/support/tickets/:id/assign` | `asyncHandler(assignTicket)` | — |
| POST | `/support/tickets/:id/close` | `asyncHandler(closeTicket)` | — |
| POST | `/support/tickets/:id/escalate` | `asyncHandler(escalateTicket)` | — |
| POST | `/support/tickets/:id/messages` | `asyncHandler(addAgentMessage)` | — |
| POST | `/support/tickets/:id/resolve` | `asyncHandler(resolveTicket)` | — |
| GET | `/support/tickets/mine` | `isCustomerLoggedIn` | — |
| GET | `/support/tickets/mine/:id` | `isCustomerLoggedIn` | — |
| POST | `/support/tickets/mine/:id/feedback` | `isCustomerLoggedIn` | — |
| POST | `/support/tickets/mine/:id/messages` | `isCustomerLoggedIn` | — |
