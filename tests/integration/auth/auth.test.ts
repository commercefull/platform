...
describe('Auth Feature Tests', () => {
  ...
  describe('Admin Auth Management API', () => {
    it('should get user authentication details with camelCase properties', async () => {
      const response = await client.get(`/api/admin/auth/user/${testCustomerId}?userType=customer`, {
    ...
    it('should revoke all refresh tokens for a user', async () => {
      const response = await client.post('/api/admin/auth/revoke-tokens', {
    ...
    it('should force reset a user password', async () => {
      const response = await client.post('/api/admin/auth/force-reset', {
        userId: testCustomerId,
        userType: 'customer',
  ...
  describe('Cleanup API', () => {
    it('should clean up expired tokens with proper count reporting', async () => {
      const response = await client.post('/api/admin/auth/cleanup-tokens', {}, {
        headers: { Authorization: `Bearer ${adminToken}` }
      });
