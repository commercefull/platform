...
describe('Basket Feature Tests', () => {
  ...
  describe('Basket Items API', () => {
    ...
    it('should update an item quantity', async () => {
      const response = await client.patch(
        `/customer/basket/${guestBasketId}/items/${createdBasketItemId}`,
        {
          quantity: 5,
        },
        {
    ...
    it('should set item as gift', async () => {
      const response = await client.post(
        `/customer/basket/${guestBasketId}/items/${createdBasketItemId}/gift`,
        {
  ...
  describe('Basket Operations API', () => {
    ...
    it('should merge baskets', async () => {
      ...
      const sessionBasketResponse = await client.post(
        '/customer/basket',
        {
      ...
      const customerBasketResponse = await client.post(
        '/customer/basket',
        {
      ...
      await client.post(
        `/customer/basket/${sessionBasketId}/items`,
        {
    ...
    it('should assign basket to customer', async () => {
      ...
      const response = await client.post(
        `/customer/basket/${newBasketId}/assign`,
        {
          customerId,
        },
        {
    ...
    describe('Basket Expiration API', () => {
      it('should extend basket expiration', async () => {
        const response = await client.put(
          `/customer/basket/${guestBasketId}/expiration`,
          {
            days: 14,
          },
          {
