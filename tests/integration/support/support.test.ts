...
describe('Support Feature Tests', () => {
  ...
  describe('Customer Tickets', () => {
    ...
    it('UC-SUP-032: should get my tickets (customer)', async () => {
      const response = await client.get('/customer/support/tickets/mine', {
        headers: { Authorization: `Bearer ${customerToken}` },
      });
    ...
    it('UC-SUP-033: should get my ticket details (customer)', async () => {
      const response = await client.get(`/customer/support/tickets/mine/${customerTicketId}`, {
        headers: { Authorization: `Bearer ${customerToken}` },
      });
    ...
    it('UC-SUP-034: should add customer message', async () => {
      const response = await client.post(
        `/customer/support/tickets/mine/${customerTicketId}/messages`,
        {
  ...
  describe('FAQ Public Access', () => {
    it('UC-SUP-027: should get public FAQ categories', async () => {
      const response = await client.get('/customer/support/faq/categories');
    ...
    it('UC-SUP-029: should search FAQ', async () => {
      const response = await client.get('/customer/support/faq/search', {
        params: { q: 'test' },
      });
