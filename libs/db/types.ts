...
export type IdentityUserSession = {
  sessionId: string;
  userId: string;
  userType: string;
  email: string;
...
export type InventoryAllocationRule = {
  ...
  maxAllocationPerOrder: number | null;
  conditions: unknown | null;
  priority: number;
  isActive: boolean;
};
...
export type LocalizationCategoryTranslation = {
...
export type MarketplaceVendorPayout = {
  payoutId: string;
  vendorId: string;
  organizationId: string;
  payoutNumber: string;
...
export type SubscriptionDunningAttempt = {
...
export type TaxVatRegistration = {
...
export type TaxVatValidationLog = {
...
export type ThemeOverride = {
  ...
  customHeadTags: unknown[] | null;
  customBodyAttributes: Record<string, unknown> | null;
  isActive: boolean;
  createdAt: Date;
  updatedAt: Date;
};
