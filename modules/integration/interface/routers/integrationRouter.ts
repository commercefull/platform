...
router.post(
  '/integration/:integrationId/deactivate',
  asyncHandler(integrationController.deactivateIntegration.bind(integrationController)),
);
...
router.put(
  ...
  asyncHandler(integrationController.updateCredential.bind(integrationController)),
);
router.delete(
  '/integration/:integrationId/credentials/:credentialId',
...
// Event subscriptions
router.post(
  '/integration/:integrationId/subscriptions',
  asyncHandler(integrationController.createSubscription.bind(integrationController)),
);
