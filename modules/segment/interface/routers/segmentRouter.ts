...
segmentBusinessRouter.get(
  '/segment/:segmentId',
  isOrganizationLoggedIn,
  asyncHandler(segmentController.getSegment.bind(segmentController)),
);
...
segmentBusinessRouter.put(
  '/segment/:segmentId',
  isOrganizationLoggedIn,
  asyncHandler(segmentController.updateSegment.bind(segmentController)),
);
segmentBusinessRouter.delete(
  '/segment/:segmentId',
  isOrganizationLoggedIn,
  asyncHandler(segmentController.deleteSegment.bind(segmentController)),
);

// Segment evaluation & members
segmentBusinessRouter.post(
  '/segment/:segmentId/evaluate',
  isOrganizationLoggedIn,
  asyncHandler(segmentController.evaluateSegment.bind(segmentController)),
);
segmentBusinessRouter.get(
