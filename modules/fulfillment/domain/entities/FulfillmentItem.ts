...
export class FulfillmentItem {
  ...
  // Getters
  get fulfillmentItemId(): string { return this.props.fulfillmentItemId; }
  ...
  get quantityOrdered(): number { return this.props.quantityOrdered; }
  get quantityFulfilled(): number { return this.props.quantityFulfilled; }
  get quantityPicked(): number { return this.props.quantityPicked ?? 0; }
  get quantityPacked(): number { return this.props.quantityPacked ?? 0; }
  get warehouseLocation(): string | undefined { return this.props.warehouseLocation; }
  get binLocation(): string | undefined { return this.props.binLocation; }
  get isPicked(): boolean { return this.props.isPicked; }
  get isPacked(): boolean { return this.props.isPacked; }
   ...
   */
  static create(props: Omit<FulfillmentItemProps, 'fulfillmentItemId' | 'createdAt' | 'updatedAt' | 'isPicked' | 'isPacked'>): FulfillmentItem {
    const now = new Date();
