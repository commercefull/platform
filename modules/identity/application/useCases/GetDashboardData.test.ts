...
describe('GetDashboardDataUseCase', () => {
  ...
  it('should get recent orders with the requested limit', async () => {
    dashboardRepo.getRecentOrders.mockResolvedValue([
      { orderId: 'o1', orderNumber: 'ORD-1', customerName: 'Cust', totalAmountCents: 100, status: 'pending', createdAt: new Date() },
    ]);
  ...
  it('should get revenueCents by day', async () => {
    dashboardRepo.getRevenueByDay.mockResolvedValue([{ date: '2024-01-01', revenueCents: 500, orders: 3 }]);
