...
b2bBusinessRouter.put(
  '/companies/:companyId/payment-terms',
  isOrganizationLoggedIn,
  asyncHandler(b2bController.setPaymentTerms.bind(b2bController)),
);
b2bBusinessRouter.put(
  '/companies/:companyId/credit-limit',
  isOrganizationLoggedIn,
  asyncHandler(b2bController.setCreditLimit.bind(b2bController)),
);
b2bBusinessRouter.post(
  '/companies/:companyId/approve',
  isOrganizationLoggedIn,
  asyncHandler(b2bController.approveCompany.bind(b2bController)),
);
b2bBusinessRouter.post(
  '/companies/:companyId/suspend',
  isOrganizationLoggedIn,
  asyncHandler(b2bController.suspendCompany.bind(b2bController)),
);
b2bBusinessRouter.post(
  '/companies/:companyId/reactivate',
  isOrganizationLoggedIn,
  asyncHandler(b2bController.reactivateCompany.bind(b2bController)),
);
b2bBusinessRouter.post(
  '/companies/:companyId/terminate',
  isOrganizationLoggedIn,
  asyncHandler(b2bController.terminateCompany.bind(b2bController)),
);
b2bBusinessRouter.get(
  '/companies/:companyId/subsidiaries',
  isOrganizationLoggedIn,
  asyncHandler(b2bController.listSubsidiaries.bind(b2bController)),
);
...
b2bBusinessRouter.put(
  ...
  isOrganizationLoggedIn,
  asyncHandler(b2bController.setSpendingLimits.bind(b2bController)),
);
...
b2bBusinessRouter.post(
  ...
  isOrganizationLoggedIn,
  asyncHandler(b2bController.addQuoteLineItem.bind(b2bController)),
);
b2bBusinessRouter.put(
  '/quotes/:quoteId/line-items/:lineItemId',
  isOrganizationLoggedIn,
  asyncHandler(b2bController.updateQuoteLineItem.bind(b2bController)),
);
b2bBusinessRouter.delete(
  '/quotes/:quoteId/line-items/:lineItemId',
  isOrganizationLoggedIn,
  asyncHandler(b2bController.removeQuoteLineItem.bind(b2bController)),
);
...
b2bBusinessRouter.put(
  '/quotes/:quoteId/internal-notes',
  isOrganizationLoggedIn,
  asyncHandler(b2bController.setQuoteInternalNotes.bind(b2bController)),
);
...
b2bBusinessRouter.post(
  '/approvals/:workflowId/approve',
  isOrganizationLoggedIn,
  asyncHandler(b2bController.approveWorkflow.bind(b2bController)),
);
b2bBusinessRouter.post(
  '/approvals/:workflowId/reject',
  isOrganizationLoggedIn,
  asyncHandler(b2bController.rejectWorkflow.bind(b2bController)),
);
b2bBusinessRouter.post(
  '/approvals/:workflowId/escalate',
  isOrganizationLoggedIn,
  asyncHandler(b2bController.escalateWorkflow.bind(b2bController)),
);
b2bBusinessRouter.post(
  '/approvals/:workflowId/cancel',
  isOrganizationLoggedIn,
  asyncHandler(b2bController.cancelWorkflow.bind(b2bController)),
);
