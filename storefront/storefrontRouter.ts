...
import { userContactUsValidationRules, validateContactUs } from "../features/content/validator";
import {
  getHomePage,
  getAboutUsPage,
  ...
  getContactUsPage,
  submitContactForm
} from "../features/content/controllers/pageCustomerController";
import { getActiveContentTypes, getPublishedPageBySlug, getPublishedPages } from "../features/content/controllers/contentCustomerController";
