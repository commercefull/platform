...
import { getAllProducts, getProductById, createProduct, updateProduct, deleteProduct, updateProductStatus, updateProductVisibility, getRelatedProducts, getProductsByCategory, getProductWithVariants } from "./controllers/productMerchantController";
import { getVariantsByProductId, getVariantById, createVariant, updateVariant, deleteVariant, setDefaultVariant, updateInventory, adjustInventory, reorderVariants } from "./controllers/variantMerchantController";
import { getImagesByProductId, getImagesByVariantId, getImageById, createImage, updateImage, deleteImage, setPrimaryImage, reorderImages } from "./controllers/imageMerchantController";
...
export const productMerchantRouter = router;
