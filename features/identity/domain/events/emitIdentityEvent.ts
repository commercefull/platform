...
export function emitCustomerPasswordResetRequested(
  payload: Omit<PasswordResetRequestedEvent, 'timestamp' | 'userType'>
): void {
...
export function emitCustomerPasswordResetCompleted(
  payload: Omit<PasswordResetCompletedEvent, 'timestamp' | 'userType'>
): void {
...
export function emitCustomerTokenRefreshed(
  payload: Omit<TokenRefreshedEvent, 'timestamp' | 'userType'>
): void {
...
export function emitMerchantPasswordResetRequested(
  payload: Omit<PasswordResetRequestedEvent, 'timestamp' | 'userType'>
): void {
...
export function emitMerchantPasswordResetCompleted(
  payload: Omit<PasswordResetCompletedEvent, 'timestamp' | 'userType'>
): void {
...
export function emitMerchantTokenRefreshed(
  payload: Omit<TokenRefreshedEvent, 'timestamp' | 'userType'>
): void {
...
export function emitSessionCreated(payload: Omit<SessionCreatedEvent, 'timestamp'>): void {
  const eventType = payload.userType === 'customer' 
