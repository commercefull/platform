...
export class PricingController {
   ...
   */
  async getTierPrices(req: Request, res: Response): Promise<void> {
    try {
      const {
        page = "1",
        limit = "20",
   ...
   */
  async getTierPrice(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
   ...
   */
  async createTierPrice(req: Request, res: Response): Promise<void> {
    try {
   ...
   * Update a tier price
   */
  async updateTierPrice(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
      const tierPriceData = req.body;
   ...
   * Delete a tier price
   */
  async deleteTierPrice(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
   ...
   */
  async getPriceLists(req: Request, res: Response): Promise<void> {
    try {
      const {
        page = "1",
        limit = "20",
   ...
   */
  async addPriceToList(req: Request, res: Response): Promise<void> {
    try {
