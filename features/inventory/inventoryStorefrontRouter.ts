...
import { getLocationInventory, getProductInventory, releaseCartReservations, reserveCartItems } from "./controllers/inventoryStorefrontController";
...
export const inventoryStorefrontRouter = router;
