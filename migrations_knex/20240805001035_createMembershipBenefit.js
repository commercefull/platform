...
exports.down = function (knex) {
  return knex.schema.dropTable('membership_benefit')
    .then(() => knex.schema.raw('DROP TYPE IF EXISTS membership_benefit_type'))
    .then(() => knex.schema.raw('DROP TYPE IF EXISTS membership_benefit_value_type'));
};
