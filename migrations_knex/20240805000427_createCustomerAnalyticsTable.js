exports.up = function(knex) {
  return knex.schema.createTable('customerAnalytics', t => {
    t.uuid('customerAnalyticsId').primary().defaultTo(knex.raw('uuid_generate_v4()'));
...
exports.down = function(knex) {
  return knex.schema.dropTable('customerAnalytics');
};
