...
exports.up = function (knex) {
  return knex.schema
    .createTable('currency', t => {
      t.uuid('currencyId').primary().defaultTo(knex.raw('uuid_generate_v4()'));
    ...
    .then(() => {
      return knex.schema.raw('CREATE UNIQUE INDEX currency_is_default_unique_index ON currency ("isDefault") WHERE "isDefault" = true');
    })
