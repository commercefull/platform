...
exports.up = function (knex) {
  return knex.schema.createTable('currencyExchangeRate', t => {
    ...
    t.index('lastUpdated');
        ...
        return knex.raw('CREATE UNIQUE INDEX idxCurrencyExchangeRateUniqueActivePair ON "currencyExchangeRate" ("sourceCurrencyId", "targetCurrencyId") WHERE "isActive" = true AND "effectiveTo" IS NULL');
  });
};
