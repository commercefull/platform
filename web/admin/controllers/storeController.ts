  ...
  try {
    const result = await createStoreUseCase.execute(
      new CreateStoreCommand({
        ...
        storeType: (req.body as RequestBody).storeType || 'business_store',
        businessId: (req.body as RequestBody).businessId || undefined,
        merchantId: (req.body as RequestBody).merchantId || undefined,
